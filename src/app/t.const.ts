const T = {
  ...
  F: {
    ...
    KIAMI: {
      DIALOG_INITIAL: {
        TITLE: 'F.KIAMI.DIALOG_INITIAL.TITLE',
      },
      FORM: {
        FILTER_USER: 'F.KIAMI.FORM.FILTER_USER',
        KIAMI_BASE_URL: 'F.KIAMI.FORM.GITLAB_BASE_URL',
        IS_AUTO_ADD_TO_BACKLOG: 'F.KIAMI.FORM.IS_AUTO_ADD_TO_BACKLOG',
        IS_AUTO_POLL: 'F.KIAMI.FORM.IS_AUTO_POLL',
        IS_SEARCH_ISSUES_FROM_KIAMI: 'F.KIAMI.FORM.IS_SEARCH_ISSUES_FROM_KIAMI',
        PROJECT: 'F.KIAMI.FORM.PROJECT',
        SCOPE: 'F.KIAMI.FORM.SCOPE',
        SCOPE_ALL: 'F.KIAMI.FORM.SCOPE_ALL',
        SCOPE_ASSIGNED: 'F.KIAMI.FORM.SCOPE_ASSIGNED',
        SCOPE_CREATED: 'F.KIAMI.FORM.SCOPE_CREATED',
        SOURCE: 'F.KIAMI.FORM.SOURCE',
        SOURCE_GLOBAL: 'F.KIAMI.FORM.SOURCE_GLOBAL',
        SOURCE_GROUP: 'F.KIAMI.FORM.SOURCE_GROUP',
        SOURCE_PROJECT: 'F.KIAMI.FORM.SOURCE_PROJECT',
        TOKEN: 'F.KIAMI.FORM.TOKEN',
      },
      FORM_SECTION: {
        HELP: 'F.KIAMI.FORM_SECTION.HELP',
        TITLE: 'F.KIAMI.FORM_SECTION.TITLE',
      },
      ISSUE_CONTENT: {
        ASSIGNEE: 'F.KIAMI.ISSUE_CONTENT.ASSIGNEE',
        AT: 'F.KIAMI.ISSUE_CONTENT.AT',
        DESCRIPTION: 'F.KIAMI.ISSUE_CONTENT.DESCRIPTION',
        LABELS: 'F.KIAMI.ISSUE_CONTENT.LABELS',
        MARK_AS_CHECKED: 'F.KIAMI.ISSUE_CONTENT.MARK_AS_CHECKED',
        PROJECT: 'F.KIAMI.ISSUE_CONTENT.PROJECT',
        STATUS: 'F.KIAMI.ISSUE_CONTENT.STATUS',
        SUMMARY: 'F.KIAMI.ISSUE_CONTENT.SUMMARY',
        WRITE_A_COMMENT: 'F.KIAMI.ISSUE_CONTENT.WRITE_A_COMMENT',
      },
      S: {
        ERR_UNKNOWN: 'F.KIAMI.S.ERR_UNKNOWN',
      },
    },
    GOOGLE: {
      BANNER: {
